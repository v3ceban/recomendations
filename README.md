...
This is a JavaScript project that can be run using Node.js. To read detailed jsdoc documentation, open `docs/index.html` in your browser.

To execute the algorithms, follow these steps:
